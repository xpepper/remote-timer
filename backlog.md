...
**As a** remote team member, **I want** a countdown timer that I can start, pause, and reset, **so that** I can manage my focus sessions effectively.

**Acceptance Criteria:**
- Timer can be started with a specific duration
- Timer can be paused and resumed
- Timer can be reset to initial state
...
### 8. Pomodoro Session Configuration
